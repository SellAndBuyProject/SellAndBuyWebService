...
public class ConstantUtil {
    ...
    // Exceptions messages
    public final static String PRODUCT_NOT_FOUND = "El producto no existe.";
    public final static String ORDER_BY_USER_NOT_FOUND = "Este usuario no tiene pedidos.";
    public final static String ORDER_NOT_SUCCESS = "No se ha podido tramitar el pedido ya que la cesta está vacía.";
    public final static String USER_NOT_FOUND = "El usuario no existe.";
    public final static String USER_DUPLICATE_EXCEPTION = "El nombre de usuario y/o email ya existen.";
    public final static String PRODUCT_DUPLICATE_EXCEPTION = "El producto ya está añadido en la wishlist.";
    public final static String PRODUCT_SOLD_EXCEPTION = "Lo sentimos, el producto ya ha sido vendido.";
