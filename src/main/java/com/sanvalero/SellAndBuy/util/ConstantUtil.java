...
public class ConstantUtil {
    ...
    // Exceptions messages
    public final static String PRODUCT_NOT_FOUND = "El producto buscado no existe";
    public final static String ORDER_BY_USER_NOT_FOUND = "Este usuario no tiene pedidos";
    public final static String ORDER_NOT_SUCCESS = "No se ha podido registrar el pedido, no tiene productos";
